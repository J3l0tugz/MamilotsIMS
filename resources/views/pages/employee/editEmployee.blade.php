...
@section('content')
    <div class="container-fluid">
        ...
        <h1 class="h3 mb-2 text-white mx-3" style="font-weight: 700;">Edit @if($employee['role'] == 0)employee @elseif ($employee['role'] == 1)manager @endif</h1>
        <div class="col d-flex justify-content-center">
            <div class="card mb-4 col-12">
                <div class="card-body">
                    <div class="float-right">
                        <a href="{{ route('employee.index') }}" class="btn btn-sm shadow btn-warning mb-4"><div class="fa fa-arrow-alt-circle-left mr-lg-2 m-1"></div>Go back</a>
                    </div>
                    <div class="mt-5">
