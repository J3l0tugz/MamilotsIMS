            ...
            <div class="card mb-4 col-12">
                <div class="card-body">
                    <div class="float-right">
                        <a href="{{ route('material.indexEmployee') }}" class="btn btn-sm shadow btn-warning mb-4"><div class="fa fa-arrow-alt-circle-left mr-lg-2 m-1"></div>Go back</a>
                    </div>
                    <div class="mt-5">
                        <form method="POST" action="{{ route('material.updateEmployee', ['id' => $material->id]) }}">
                            @csrf
