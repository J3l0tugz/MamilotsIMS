...
@section('content')
    <div class="container">
        <h3 for="text" class="text-white"><strong>Scan to Decrease Product</strong></h3>
        ...
        <div class="row">
            <div class="col-md-7 mb-0 p-0">
                ...
                @if (@session()->has('error'))
                    <div class="bg-gradient-warning btn-icon-split shadow animated--grow-in col-12 mt-0"
            ...
            <form id="qr-form" action="{{ route('product.decreaseEmployee') }}" method="POST" class="form-horizontal">
                @csrf
                <div class="col-md-12">
