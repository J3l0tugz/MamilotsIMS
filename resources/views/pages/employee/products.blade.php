            ...
            <div class="card-body">
                <div class="float-right">
                    ...
                    <button id="myBtn-add" class="btn-primary btn-circle px-3 mb-3">
                        <a href="{{ route('product.scanEmployee') }}">
                            <li class="fa fa-plus-circle text-white"></li>
                        </a>
                    </button>
                    <!--Minus Button-->
                    <button id="myBtn-add" class="btn-primary btn-circle px-3 mb-3">
                        <a href="{{ route('product.scan.decreaseEmployee') }}">
                            ...
                            @foreach ($products as $product)
                                <tr>
                                    ...
                                    <td> <a href="#" data-toggle="modal" data-target="#deleteModal"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form
                                                            action="{{ route('product.deleteEmployee', ['id' => $product->id]) }}"
                                                            method="post">
                                                            @csrf
                                                            <button type="submit"
                                        ...
                                        <a href="{{ route('product.editEmployee', $product['id']) }}" <button
