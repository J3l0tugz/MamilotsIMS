    ...
    <div class="container-fluid">
        <div class="d-sm-flex align-items-center justify-content-between mb-0 ml-0 row">
            ...
            <div class="float-right">
                <a href="{{ route('employee.index') }}" class="btn btn-sm btn-warning shadow mr-3 mb-1"
                    style="margin-right: 12px !important; border: .35rem !important;"><img src="{{ asset('media/arrow-go-back.png') }}"
                        style="width: 20px;">Go back</a>
            </div>
        </div>
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            ...
                            <img src="{{ $employee->sex == 'Female' ? asset('media/female_profile.png') : asset('media/male_profile.png') }}"
                                alt="Profile Picture" class="img-profile rounded-circle o-hidden shadow" style="width: 60%;">
                            <h4 class="text-center text-gray-900 mt-4 mb-0">{{ $employee->first_name }} {{ $employee->middle_name }}
                                {{ $employee->last_name }}</h4>
                            <p class="text-muted text-center">@if($employee['role'] == 0) Employee @elseif ($employee['role'] == 1) Manager @endif</p>
                        </div>
                        ...
                        <a href="#" data-toggle="modal" data-target="#deleteModal"
                                            class="btn bg-gradient-danger shadow text-white btn-block mb-1"
                                            ...
                                            <div class="modal-dialog" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form
                                                            action="{{ route('employee.delete', ['id' => $employee->id]) }}"
                                                            method="post">
                                                            @csrf
                                                            <button type="submit"
